...
public class NursingProjectController extends BaseController
{
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "nursingProject", value = "查询条件对象", required = true, dataType="NursingProject", paramType="query")
    })
    ...
    @PostMapping
    public AjaxResult add(@RequestBody @ApiParam("新增护理项目对象")NursingProject nursingProject)
    {
	...
	@DeleteMapping("/{ids}")
    public AjaxResult remove(@PathVariable @ApiParam("要删除的护理项目数组") Long[] ids)
    {
