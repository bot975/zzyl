...
public class QianfanAIModelTest {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        OpenAIClient client = OpenAIOkHttpClient.builder()
                .apiKey(System.getenv("BAIDU_QIANFAN_API_KEY")) //将your_APIKey替换为真实值，如何获取API Key请查看https://cloud.baidu.com/doc/WENXINWORKSHOP/s/Um2wxbaps#步骤二-获取api-key
                .baseUrl("https://qianfan.baidubce.com/v2/") //千帆ModelBuilder平台地址
                .build();

        ChatCompletionCreateParams params = ChatCompletionCreateParams.builder()
                .addUserMessage(prompt) // 对话messages信息
                .model("ernie-4.5-turbo-32k") // 模型对应的model值，请查看支持的模型列表：https://cloud.baidu.com/doc/WENXINWORKSHOP/s/wm7ltcvgc
